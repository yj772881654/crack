...
class ResFusion_multiAttentionGenerator(nn.Module):
        def __init__(self, rate=4):
            super(ResFusion_multiAttentionGenerator, self).__init__()

            t = 1

            # self.features = vgg16_c.VGG16_C(pretrain, logger)
            self.resnext = resnext50()
            self.AttentionBlock_1 = AttentionBlock_1()
            self.AttentionBlock_2 = AttentionBlock_2()
            self.AttentionBlock_3 = AttentionBlock_3()
            self.AttentionBlock_4 = AttentionBlock_4()
            ...
            # self.conv256To1_1 = nn.Conv2d(32 * t, 1, (1, 1), stride=1) # 让每个stage输出降维
            # self.conv256To1_2 = nn.Conv2d(32 * t, 1, (1, 1), stride=1)  # 让每个stage输出降维
            ...
            # self.conv512To1_1 = nn.Conv2d(512, 1, (1, 1), stride=1)  # 让每个stage输出降维
            # self.conv512To1_2 = nn.Conv2d(512, 1, (1, 1), stride=1)  # 让每个stage输出降维
            # self.conv512To1_3 = nn.Conv2d(512, 1, (1, 1), stride=1)  # 让每个stage输出降维
            ...
            # self.conv1024To1_1 = nn.Conv2d(1024, 1, (1, 1), stride=1)  # 让每个stage输出降维
            # self.conv1024To1_2 = nn.Conv2d(1024, 1, (1, 1), stride=1)  # 让每个stage输出降维
            # self.conv1024To1_3 = nn.Conv2d(1024, 1, (1, 1), stride=1)  # 让每个stage输出降维
            # self.conv1024To1_4 = nn.Conv2d(1024, 1, (1, 1), stride=1)  # 让每个stage输出降维
            # self.conv1024To1_5 = nn.Conv2d(1024, 1, (1, 1), stride=1)  # 让每个stage输出降维
            ...
            # self.conv2048To1_1 = nn.Conv2d(2048, 1, (1, 1), stride=1)  # 让每个stage输出降维
            # self.conv2048To1_2 = nn.Conv2d(2048, 1, (1, 1), stride=1)  # 让每个stage输出降维
        ...
        def forward(self, x):
            ...
            s1_sem = self.AttentionBlock_1(features[0], features[1], s1_sem)
            ...
            s2_sem = self.AttentionBlock_2(features[3], features[4], features[5], s2_sem)
            ...
            s3_sem = self.AttentionBlock_3(features[7], features[8], features[9], features[10], features[11], s3_sem)
            ...
            s4_sem = self.AttentionBlock_4(features[13], features[14], s4_sem)
        ...
        #     loss = 0
        #     for k in range(8):
        #         loss += 0.5 * BinaryFocalLoss(outputs[k], labels)
        #     loss += 1.1 * BinaryFocalLoss(outputs[-1], labels)
        #
        #     # loss = (loss_side1 + 2 * loss_side2 + 4 * loss_side3 + 8 * loss_side4 + final_loss)
        #
        #     return loss
