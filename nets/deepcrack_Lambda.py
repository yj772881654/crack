...
class LambdaBottleneck(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.conv2 = nn.ModuleList([LambdaConv2(planes, planes)]) ###########
...
class LABlock(nn.Module):
    def __init__(self, input_channels,output_channels):
        ...
        #     nn.Conv2d(input_channels//2, 32, kernel_size=3, stride=1, padding=1, bias=True),
        #     nn.BatchNorm2d(32)
        # )
...
class LABlock2(nn.Module):
    def __init__(self, input_channels,output_channels):
        super(LABlock2, self).__init__()
        self.W_1 = nn.Sequential(
            nn.Conv2d(input_channels, output_channels, kernel_size=3, stride=1, padding=1, bias=True),
            nn.BatchNorm2d(output_channels)
        )
