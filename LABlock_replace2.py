...
class Bottleneck(nn.Module):
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.expansion = 4
        hidden_planes = max(in_planes,planes) // self.expansion
...
class Down2(nn.Module):
    ...
    def __init__(self):
        ...
        self.nn1 = PvtConvRelu(64, 128) #ConvRelu(64, 128)
...
class Down3(nn.Module):
    ...
    def __init__(self):
        ...
        self.nn1 = PvtConvRelu(128, 256) #ConvRelu(128, 256)
