...
class LABlock(nn.Module):
    def __init__(self, input_channels, output_channels=32):
        ...
        self.W_1 = nn.Sequential(
            nn.Conv2d(input_channels, inter_channels, kernel_size=3, stride=1, padding=1, bias=True)
        ...
        self.psi = nn.Sequential(
            nn.Conv2d(inter_channels, output_channels, kernel_size=3, stride=1, padding=1, bias=True),
